 ...
 */
?>
<div id="page" class="container <?php print $classes; ?> page-<?php !empty($node) ? print 'node' : print 'not-node'; ?>">

  <?php if ($site_logo || $site_slogan): ?>
  ...
  <!-- Breadcrumbs -->
  <?php if ($breadcrumb): ?>
    <div id="breadcrumb"><div class="breadcrumb-wrapper"><?php print $breadcrumb; ?></div></div>
  <?php endif; ?>
    ...
    <div id="content-column" class="content-column" role="main">
      <div class="content-inner">
        ...
        <?php print render($page['highlighted']); ?>
          ...
          <<?php print $tag; ?> id="main-content" class="<?php print $node_list_classes; ?>">
